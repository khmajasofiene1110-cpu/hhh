...
<div class="profile-page">
    ...
    <div id="pf-app" hidden>
        ...
        <section class="pf-danger">
            ...
            <button type="button" class="pf-logout" id="pf-logout">
...
<div id="pf-modal-backdrop" class="confirm-backdrop" role="presentation" hidden></div>
<div id="pf-modal" class="confirm-modal" role="alertdialog" aria-modal="true" aria-labelledby="pf-modal-title" hidden>
